...
from .views import (
    ...
    RestaurantTableViewSet, ReservationViewSet, PaymentViewSet, StaffProfileViewSet, CashierShiftViewSet, AuditLogViewSet, WastageViewSet
)
...
router.register(r'wastage', WastageViewSet)
